...
class MyLibrary{
    ...
    public void addBook(Book book){ //Since Book is a class, it means this method expects a Book object as an argument.
                                    //book is the parameter name (a variable that will store the incoming Book object).
                                    //It holds the actual object reference when the method is called.
